...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const newPasswordForm = document.querySelector(".new-password-form"); // Add reference to the new password form
    ...
    const goBackLinkNewPassword = document.getElementById("go-back-link-newpassword"); // Add reference to the "Go Back" link for the new password form
